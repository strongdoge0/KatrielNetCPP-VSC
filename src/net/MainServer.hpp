...
public:
  ...
  void (*OnReceiveCallback)(ConnectionState *connectionState,
  ...
  // template <typename... T>
  // void SendSingleMessageTo(ConnectionState *connectionState, char id,
  // MessageFlag flag, T... args);
  void SendSingleMessageTo(ConnectionState *connectionState, char id,
                           MessageFlag flag, std::vector<std::any> msg);
  void SendMessageTo(ConnectionState *connectionState, MessageFlag flag,
...
private:
  ...
  ConnectionState *FindConnectionState(struct sockaddr_in *addr);
